module DataPath(input clk, rst);
  ...
  MemoriaInstrucao instmem(endereco[6:2], clk, instrucao);//ok
  
  Somador PCJump(endereco, 32'b100, saidaSomadorPC);//+/-ok retestar
  
  assign enderecoJump = {instrucao[25:0], 2'b00};//ok
  assign jumpAddress = {saidaSomadorPC[31:28], enderecoJump};//ok
   
  Controle control(instrucao[31:26], RegDst, Jump, Branch, MemRead, MemtoReg, ALUOp, MemWrite, ALUSrc, RegWrite);//ok 
